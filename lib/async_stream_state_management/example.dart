...
import 'package:state_management_abstraction/async_stream_state_management/async_stream_state_management.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Async Stream State Management',
...
typedef _ViewModel = AsyncStreamStateManagement<UserModel>;
    ...
    return Scaffold(
      ...
      body: Center(
        child: RefreshIndicator(
          ...
          child: AsyncStreamBuilderWidget<UserViewModel, UserModel>(
